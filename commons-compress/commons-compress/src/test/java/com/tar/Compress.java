...
public class Compress {
    ...
    public void compressToTar(){
        try{
            String tarFileName = "C:\\Java-Prep\\practice-projects\\third-party-libraries\\commons-compress\\files\\tar-1.tar";

            // create TarArchiveOutputStream
            TarArchiveOutputStream tarArchiveOutputStream = new TarArchiveOutputStream(new FileOutputStream(tarFileName));
