...
## Maven Command
```
mvn archetype:generate -DgroupId=com.spring.boot.prometheus.grafana -DartifactId=prometheus-grafana -Dversion=1.0 -DarchetypeArtifactId=maven-archetype-quickstart -DinteractiveMode=false
```
