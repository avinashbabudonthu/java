...
* API Gateway or Edge Serer: Provides unified entry point for client applications. It handles routing, filtering and load balancing. Implement common features like authentication
...
* Distributed tracing: Tracing requests across microservices
* Fault Tolerence: Ensure that failure of one microservice does not cascade and make other microservices to fail. Example: Resiliency4J
------
### [<<Back](../README.md) | [Java V2 All Examples](https://github.com/avinashbabudonthu/java/blob/master/java-v2/README.md) | [Java All Examples](https://github.com/avinashbabudonthu/java/blob/master/README.md)